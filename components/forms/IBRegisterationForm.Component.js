...
export default function IBRegisterationForm() {
    ...
    const sendPin = async () => {
        setIsLoading(true);
        const resp = await generatePin({phone:`${countryCode}${phone}`, email, language})
        if(resp.isSuccess) {
            setPinStatus('sent')
    ...
    const validationSchema = Yup.object({
        type: Yup.string('Select a type').required(
          ...
          firstName: Yup.string().when('type', {
            ...
            otherwise: Yup.string('Enter company name').required( t('Company name is required'))
          }),
    ...
    const SubmitRegisterIB = async (values, {setSubmitting, setErrors, setStatus, resetForm}) => {
        setIsLoading(true)
        try {
            let data = {...values};
            ...
            const resp = await RegisterIB(data);
            if(resp.result) {
                        ...
                        <Form noValidate onSubmit={handleSubmit}>
                            <Row>
                                <Form.Group as={Col} xs="12" md="6" className="position-relative mb-4">
                                    ...
                                    <Form.Control name="firstName" type="text" value={values.firstName} onChange={handleChange} onBlur={handleBlur} isInvalid={touched.firstName && !!errors.firstName} required  />
                                ...
                                <Form.Group as={Col} xs="12" md="6" className="position-relative mb-4">
                                    ...
                                    <Form.Control name="lastName" type="text" value={values.lastName} onChange={handleChange} onBlur={handleBlur} isInvalid={touched.lastName && !!errors.lastName} required  />
                                    <Form.Control.Feedback type="invalid" tooltip>
                                        {errors.lastName}
                                    </Form.Control.Feedback>
                                </Form.Group>
                            ...
                            <Row>
                                <Form.Group as={Col} xs="12" className="position-relative mb-4">
                            ...
                            <Row>
                                <Form.Group as={Col} xs="12" md="6" className="position-relative mb-4">
                                    ...
                                    <InputGroup hasValidation>
                                      ...
                                      <Form.Control name="phone" type="text" autoComplete="off" value={values.phone} onChange={
                                            (e) => {
                                                resetPinField();
                                ...
                                <Form.Group as={Col} xs="12" md="6" className="position-relative mb-4">
                                    ...
                                    <Form.Control name="email" type="email" value={values.email} onChange={
                                            (e) => {
                                                resetPinField();
                            ...
                            <Row>
                                <Form.Group as={Col} xs="12" md="6" className="position-relative mb-4">
                                    ...
                                    <InputGroup hasValidation>
                                        <Form.Control name="portalPassword" type={passwordView ? 'text' : 'password'} value={values.portalPassword} onChange={handleChange} onBlur={handleBlur} isInvalid={touched.portalPassword && !!errors.portalPassword} required />
                                ...
                                <Form.Group as={Col} xs="12" md="6" className="position-relative mb-4">
                                    ...
                                    <InputGroup hasValidation>
                                        <Form.Control name="portalPasswordConfirm" type={confirmPasswordView ? 'text' : 'password'} value={values.portalPasswordConfirm} onChange={handleChange} onBlur={handleBlur} isInvalid={touched.portalPasswordConfirm && !!errors.portalPasswordConfirm} required />
