...
<h4>{t('Register now easy')}</h4>
                            ...
                            <Row>
                                <Form.Group as={Col} xs="12" md={(values.type === 'individual') ? '6' : '12'} className="position-relative mb-4">
                                    ...
                                    <Form.Control name="firstName" placeholder={t((values.type === 'individual') ? 'First name' : 'Company name')} type="text" value={values.firstName} onChange={handleChange} onBlur={handleBlur} isInvalid={touched.firstName && !!errors.firstName} required  />
                                    <Form.Control.Feedback type="invalid" tooltip>
                                        {errors.firstName}
                                    </Form.Control.Feedback>
                                </Form.Group>
